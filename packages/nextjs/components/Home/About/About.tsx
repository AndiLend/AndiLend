...
const About = () => {
  return (
    <div className="h-screen bg-white flex flex-col items-center justify-center gap-14">
      ...
      <div className="flex items-center gap-20 justify-center">
        <div className="flex flex-col items-center w-1/4">
          ...
          <p className="text-black text-center">We protect your information and it is safe from scamers</p>
        </div>
        <div className="flex flex-col items-center w-1/4">
