    ...
    <div className="container-founding">
      <form className="space-y-6 form-founding" action="#" method="POST">
        ...
        <div className="form-submit">
          <button
            type="submit"
            className="flex items-center justify-center w-full px-4 py-2 text-sm font-medium text-black bg-indigo-600 border border-transparent rounded-md shadow-sm hover:bg-indigo-700 focus:outline-none focus:border-indigo-700 focus:ring focus:ring-indigo-200"
          >
            Get Funding
          </button>
        </div>
