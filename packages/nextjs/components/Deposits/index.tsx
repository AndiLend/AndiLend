...
const Deposits = () => {
  const { fundingReceived, interest, totalPayment, scoreData, feeCounts, isPending } = useDeposits();
  return (
    <div className="p-4 h-full flex flex-col">
      ...
      <div className="flex h-full gap-4 pt-4">
        <div className="flex flex-auto w-64">
          <FundingHistoryChart
            fundingReceived={fundingReceived.toString()}
            interest={interest.toString()}
            totalPayment={totalPayment.toString()}
            feeCounts={feeCounts.toString()}
            isPending={isPending}
          />
        </div>
